...
function prepareData(startData: startDataType, stays: confirmedStays) {
  // A bit ugly code, but sometimes this is what it takes when working with real data 😅

  function incArrayValue(arr: startDataType, fields: string) {
    return arr.map((obj) => (obj?.duration === fields ? { ...obj, value: obj.value + 1 } : obj));
  }
...
interface DurantionChartProps {
  confirmedStays: confirmedStays;
}
function DurationChart({ confirmedStays }: DurantionChartProps) {
